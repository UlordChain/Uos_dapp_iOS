...
//  Copyright © 2018 thgyuip. All rights reserved.
//
...
+ (CGSize)getStringRectInTextViewWithString:(NSString *)string InTextView:(UITextView *)textView withAttributesDict:(NSDictionary *)attributesDict{
    ...
    CGSize calculatedSize =  [string boundingRectWithSize:InSize options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:attributesDict context:nil].size;
